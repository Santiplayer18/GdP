...
package net.santiplayer.gdpmod.world;

import org.jline.terminal.Size;

import net.santiplayer.gdpmod.item.ItemCardenosaDeVolpejera;
import net.santiplayer.gdpmod.ElementsGdpModMod;
...
@ElementsGdpModMod.ModElement.Tag
public class WorldCardenosaDeVolpejera extends ElementsGdpModMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("gdp_mod:cardenosa_de_volpejera_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldCardenosaDeVolpejera(ElementsGdpModMod instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new ItemCardenosaDeVolpejera().setUnlocalizedName("cardenosa_de_volpejera").setRegistryName("cardenosa_de_volpejera"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension cardenosa_de_volpejera is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("cardenosa_de_volpejera", "_cardenosa_de_volpejera", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemCardenosaDeVolpejera.block, 0,
				new ModelResourceLocation("gdp_mod:cardenosa_de_volpejera", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.BEDROCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("cardenosa_de_volpejera_portal");
			setRegistryName("cardenosa_de_volpejera_portal");
		...
		public static class Size {
			...
			protected int calculatePortalHeight() {
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.BEDROCK
